...
/**
   ...
   * `prisma.softskills`: Exposes CRUD operations for the **Softskills** model.
    ...
    * ```
    */
  get softskills(): Prisma.SoftskillsDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type LinksTypePropsSelect = {
    links?: boolean | TechsTypePropsArgs
  }


  export type LinksTypePropsInclude = {}

  export type LinksTypePropsGetPayload<S extends boolean | null | undefined | LinksTypePropsArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? LinksTypeProps :
    S extends undefined ? never :
    S extends { include: any } & (LinksTypePropsArgs)
    ? LinksTypeProps 
    : S extends { select: any } & (LinksTypePropsArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'links' ? Array < TechsTypePropsGetPayload<S['select'][P]>>  :  P extends keyof LinksTypeProps ? LinksTypeProps[P] : never
  } 
      : LinksTypeProps



  export interface LinksTypePropsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
  ...
  /**
   * The delegate class that acts as a "Promise-like" for LinksTypeProps.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__LinksTypePropsClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    links<T extends TechsTypePropsArgs= {}>(args?: Subset<T, TechsTypePropsArgs>): Prisma.PrismaPromise<Array<TechsTypePropsGetPayload<T>>| Null>;
   ...
   */
  export type LinksTypePropsArgs = {
    /**
     * Select specific fields to fetch from the LinksTypeProps
     */
    select?: LinksTypePropsSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: LinksTypePropsInclude | null
  }
  ...
  export type TechsTypePropsSelect = {
    id?: boolean
    svg_name?: boolean
    link?: boolean
    svg_link?: boolean
  ...
  export type TechsTypePropsGetPayload<S extends boolean | null | undefined | TechsTypePropsArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? TechsTypeProps :
    S extends undefined ? never :
    S extends { include: any } & (TechsTypePropsArgs)
    ? TechsTypeProps 
    : S extends { select: any } & (TechsTypePropsArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof TechsTypeProps ? TechsTypeProps[P] : never
  } 
      : TechsTypeProps



  export interface TechsTypePropsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
  ...
  /**
   * The delegate class that acts as a "Promise-like" for TechsTypeProps.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__TechsTypePropsClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
   ...
   */
  export type TechsTypePropsArgs = {
    /**
     * Select specific fields to fetch from the TechsTypeProps
     */
    select?: TechsTypePropsSelect | null
  }
  ...
  export type ProjectSelect = {
    ...
    description?: boolean
    techs?: boolean | LinksTypePropsArgs
    created_at?: boolean
  }
  ...
  export type ProjectGetPayload<S extends boolean | null | undefined | ProjectArgs> =
    ...
    : S extends { select: any } & (ProjectArgs | ProjectFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'techs' ? LinksTypePropsGetPayload<S['select'][P]> :  P extends keyof Project ? Project[P] : never
  } 
      : Project
  ...
  export class Prisma__ProjectClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    techs<T extends LinksTypePropsArgs= {}>(args?: Subset<T, LinksTypePropsArgs>): Prisma__LinksTypePropsClient<LinksTypePropsGetPayload<T> | Null>;
  ...
  export type SkillsGetPayload<S extends boolean | null | undefined | SkillsArgs> =
    ...
    : S extends { select: any } & (SkillsArgs | SkillsFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof Skills ? Skills[P] : never
  } 
      : Skills
   ...
   * Skills aggregateRaw
   */
  export type SkillsAggregateRawArgs = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type SoftskillsAggregateArgs = {
    /**
  ...
  export type SoftskillsGroupByArgs = {
    where?: SoftskillsWhereInput
  ...
  export type SoftskillsGetPayload<S extends boolean | null | undefined | SoftskillsArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Softskills :
    S extends undefined ? never :
    S extends { include: any } & (SoftskillsArgs | SoftskillsFindManyArgs)
    ? Softskills 
    : S extends { select: any } & (SoftskillsArgs | SoftskillsFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof Softskills ? Softskills[P] : never
  } 
      : Softskills


  type SoftskillsCountArgs = 
    Omit<SoftskillsFindManyArgs, 'select' | 'include'> & {
      select?: SoftskillsCountAggregateInputType | true
    }

  export interface SoftskillsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends SoftskillsFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, SoftskillsFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Softskills'> extends True ? Prisma__SoftskillsClient<SoftskillsGetPayload<T>> : Prisma__SoftskillsClient<SoftskillsGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends SoftskillsFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, SoftskillsFindUniqueOrThrowArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends SoftskillsFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, SoftskillsFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Softskills'> extends True ? Prisma__SoftskillsClient<SoftskillsGetPayload<T>> : Prisma__SoftskillsClient<SoftskillsGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends SoftskillsFindFirstOrThrowArgs>(
      args?: SelectSubset<T, SoftskillsFindFirstOrThrowArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends SoftskillsFindManyArgs>(
      args?: SelectSubset<T, SoftskillsFindManyArgs>
    ): Prisma.PrismaPromise<Array<SoftskillsGetPayload<T>>>
     ...
     * 
    **/
    create<T extends SoftskillsCreateArgs>(
      args: SelectSubset<T, SoftskillsCreateArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends SoftskillsCreateManyArgs>(
      args?: SelectSubset<T, SoftskillsCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends SoftskillsDeleteArgs>(
      args: SelectSubset<T, SoftskillsDeleteArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
     ...
     * 
    **/
    update<T extends SoftskillsUpdateArgs>(
      args: SelectSubset<T, SoftskillsUpdateArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends SoftskillsDeleteManyArgs>(
      args?: SelectSubset<T, SoftskillsDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends SoftskillsUpdateManyArgs>(
      args: SelectSubset<T, SoftskillsUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends SoftskillsUpsertArgs>(
      args: SelectSubset<T, SoftskillsUpsertArgs>
    ): Prisma__SoftskillsClient<SoftskillsGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__SoftskillsClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
   ...
   */
  export type SoftskillsFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
    /**
   ...
   */
  export interface SoftskillsFindUniqueArgs extends SoftskillsFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type SoftskillsFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   */
  export type SoftskillsFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   */
  export interface SoftskillsFindFirstArgs extends SoftskillsFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type SoftskillsFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   * Softskills findMany
   */
  export type SoftskillsFindManyArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   * Softskills create
   */
  export type SoftskillsCreateArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   */
  export type SoftskillsCreateManyArgs = {
    /**
   ...
   * Softskills update
   */
  export type SoftskillsUpdateArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   */
  export type SoftskillsUpdateManyArgs = {
    /**
   ...
   * Softskills upsert
   */
  export type SoftskillsUpsertArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   * Softskills delete
   */
  export type SoftskillsDeleteArgs = {
    /**
     * Select specific fields to fetch from the Softskills
     */
    select?: SoftskillsSelect | null
   ...
   */
  export type SoftskillsDeleteManyArgs = {
    /**
     * Filter which Softskills to delete
     */
    where?: SoftskillsWhereInput
   ...
   * Softskills findRaw
   */
  export type SoftskillsFindRawArgs = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   */
  export type SoftskillsAggregateRawArgs = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
